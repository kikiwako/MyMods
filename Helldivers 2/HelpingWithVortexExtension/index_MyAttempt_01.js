...
const loadOrderCallback = (updatedLoadOrder, mods) => {
  if (loadOrder === undefined) loadOrder = updatedLoadOrder;
  if (updatedLoadOrder === loadOrder) return;
...
const mergeOperation = (filePath, mergePath, context, loadOrder) => {
  console.log({ filePath, mergePath, context, loadOrder });
}

const RAJISSTARR = (context, loadOrder) => {
  try {
...
function main(context) {
  ...
  context.registerLoadOrderPage({
    ...
    callback: loadOrderCallback(updatedLoadOrder, mods),
    createInfoPanel: () =>
  ...
  context.api.onAsync('will-deploy',
    (profiled, oldDeployment) => RAJISSTARR(context, loadOrder)
  );
